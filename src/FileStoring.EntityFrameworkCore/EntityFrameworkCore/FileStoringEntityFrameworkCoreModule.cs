...
{
    [DependsOn(
        typeof(FileStoringDomainModule),
    ...
    public class FileStoringEntityFrameworkCoreModule : AbpModule
    {
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpDbContextOptions>(options =>
            {
                 ...
                 * See also FileStoringMigrationsDbContextFactory for EF Core tooling. */
